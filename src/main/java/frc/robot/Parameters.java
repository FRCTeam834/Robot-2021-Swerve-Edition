...
public final class Parameters {
    ...
    public static final class driveTrain {
        ...
        public static final class auton {
            ...
            public static final double TURN_180_STEER_RATE_PERCENT =
                    0.5; // Percentage of maxSteerRate (from driver profile)
        }
    }
    ...
    public static final class shooter {
        ...
        public static final double SPOOL_TIME =
                1; // The amount of time (in s) required to spin up the shooter
        ...
        public static final double MOUTH_WIDTH =
                6.25 / 12; // Currently a placeholder; best be in feet
    }
    ...
    public static final class conveyor {
        ...
        public static final double EJECT_TIME =
