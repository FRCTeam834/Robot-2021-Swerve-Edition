...
public class RobotContainer {
    ...
    private final JoystickButton xboxStart = new JoystickButton(xbox, Button.kStart.value),
            xboxBack = new JoystickButton(xbox, Button.kBack.value),
            xboxB = new JoystickButton(xbox, Button.kB.value),
            xboxA = new JoystickButton(xbox, Button.kA.value),
            xboxY = new JoystickButton(xbox, Button.kY.value),
            xboxX = new JoystickButton(xbox, Button.kX.value),
            xboxLB = new JoystickButton(xbox, Button.kBumperLeft.value),
            xboxRB = new JoystickButton(xbox, Button.kBumperRight.value),
    ...
    private void configureButtonBindings() {
        ...
        BGTM.whenHeld(
                climberDown); // this moves the climber down...don't worry about it for right now
